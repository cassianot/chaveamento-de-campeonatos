...
Este projeto tem como objetivo implementar um software gerador de chaveamento para campeonatos. O usuário irá inserir todos os dados referente ao campeonato, bem como o time / competidores classificados por categorias (sub-13, sub-20, 40+, etc).
